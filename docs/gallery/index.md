...
<div class="orsg-cat__head">
  <h3 class="orsg-cat__title">Trends over time</h3>
...
<div class="orsg-grid">
  <a class="orsg-card" href="plots/area/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Area Plot</h4>
  ...
  <a class="orsg-card" href="plots/line/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Line Plot</h4>
  ...
  <a class="orsg-card" href="plots/time/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Time Plot</h4>
  ...
  <a class="orsg-card" href="plots/period_on_period/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Period on Period Plot</h4>
  ...
  <a class="orsg-card" href="plots/broken_timeline/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Broken Timeline Plot</h4>
...
<div class="orsg-grid">
  ...
  <a class="orsg-card" href="plots/index_plot/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Index Plot</h4>
  ...
  <a class="orsg-card" href="plots/waterfall/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Waterfall Plot</h4>
...
<div class="orsg-grid">
  ...
  <a class="orsg-card" href="plots/scatter/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Scatter Plot</h4>
  ...
  <a class="orsg-card" href="plots/heatmap/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Heatmap Plot</h4>
  ...
  <a class="orsg-card" href="plots/price/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Price Plot</h4>
...
<div class="orsg-grid">
  ...
  <a class="orsg-card" href="plots/customer_decision_hierarchy/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Customer Decision Hierarchy</h4>
  ...
  <a class="orsg-card" href="plots/revenue_tree/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Revenue Tree</h4>
  ...
  <a class="orsg-card" href="plots/venn/">
    <div class="orsg-card__body">
      <h4 class="orsg-card__title">Venn Diagram</h4>
